...
fun EditProfileScreen(navController: NavController) {
    ...
    var user = User()
    vm.viewModelScope.launch { user = getUserData(vm, "user") }
    ...
    Column(
        ...
        val login = rememberSaveable { mutableStateOf (user.login) }
        ...
        Button(
            ...
            enabled = login.value.isNotEmpty() && name.value.isNotEmpty() &&
                    email.value.isNotEmpty() && surname.value.isNotEmpty(),
